---
title: "Licenciatura en Física - BUAP"
description: "Reconocimiento por la conclusión satisfactoria del plan de estudios de la Licenciatura en Física en la Benemérita Universidad Autónoma de Puebla."
pubDate: 2023-12-13
readingTime: "3 min"
tags: ["Formación Académica", "Física", "BUAP"]
---

# Conclusión de Estudios de Licenciatura en Física

El 13 de diciembre de 2023 se oficializó la culminación de mis estudios de nivel superior en la **Benemérita Universidad Autónoma de Puebla (BUAP)**. Esto representa la finalización de una formación académica enfocada en la comprensión de los fenómenos naturales, el desarrollo de habilidades analíticas y la aplicación del método científico.

Durante este periodo, adquirí competencias sólidas en mecánica, electromagnetismo, termodinámica y física moderna, sentando las bases teóricas y experimentales que hoy aplico en mis proyectos de divulgación científica y desarrollo tecnológico.

<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/1TvL4NyudGnFG1FnDJEHUYC1IXM5T3C9z/view?usp=sharing" 
    target="_blank" 
    ...
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        <div class="flex items-center space-x-2 mb-3">
          ...
          <span class="text-xs font-medium text-zinc-500">FCFM - BUAP 2023</span>
        </div>
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Reconocimiento </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al reconocimeinto otorgado por la Facultad de Ciencias Físico Matemáticas de la BUAP. <strong>FCFM</strong>.
        </p>
