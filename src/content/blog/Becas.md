---
title: "Beca Fundación BBVA"
description: "Chavos que inspiran"
pubDate: 2024-03-11
readingTime: "5 min"
tags: ["Becas", "BBVA"]
---
...
El programa de becas "Por los que se quedan" de Fundación BBVA México, iniciado en 2006, apoya a estudiantes con familiares migrantes en zonas de alta migración, ofreciendo soporte económico y mentoría para evitar la deserción escolar. Actualmente, este enfoque se ha integrado al programa "Chavos que Inspiran", que ofrece becas integrales desde secundaria hasta la universidad. 

## Becas BBVA para Chavos que Inspiran
Hoy en día, este es el programa insignia. Su característica única es que acompaña al estudiante durante 10 años (desde el inicio de la secundaria hasta el final de la universidad), siempre y cuando mantenga el promedio.

## Mi Experiencia
Haber logrado ser beneficiario de una beca, fué un gran impulso en el logro de mis metas escolares, pues al tener la gran ventaja de tener un apoyo económico mensual desde el inicio de mi escuela secundaria en el 2013, hasta  el final de mi carrera universitaria en el 2024, significó un enorme motivante para poner todo mi empeño en tener buenas calificaciones y seguir aprendiendo.

<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/1orpIz6AUyc5a7qpTSk4KJciZ-_4nQIeP/view?usp=sharing" 
    target="_blank" 
    ...
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        <div class="flex items-center space-x-2 mb-3">
          ...
          <span class="text-xs font-medium text-zinc-500">BECA - BBVA 2016</span>
        </div>
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Reconocimiento </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al diploma otorgado por la Fundación BBVA Bancomer. <strong>BBVA</strong>.
        </p>
...
<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/12UXa5yc0jfZUJWNXRX_HbePpKaJxyC9e/view?usp=sharing" 
    target="_blank" 
    rel="noopener noreferrer"
    class="relative block overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-md transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl hover:border-zinc-400 dark:hover:border-zinc-600"
  >
    <div class="flex flex-col sm:flex-row">
      <div class="relative h-56 sm:h-auto sm:w-1/3 overflow-hidden bg-zinc-100 dark:bg-zinc-800">
        <img 
          src="/drive.svg" 
          alt="Reconocimiento de Organización" 
          class="h-full w-full object-cover transition-transform duration-500 group-hover:scale-110"
        />
        <div class="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/10 transition-colors">
          <div class="rounded-full bg-white/90 p-3 shadow-lg group-hover:scale-110 transition-transform">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        <div class="flex items-center space-x-2 mb-3">
          <span class="px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-white bg-blue-600 rounded-md">Reconocimiento</span>
          <span class="text-xs font-medium text-zinc-500">BECA - BBVA 2025</span>
        </div>
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Reconocimiento </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al reconocimiento otorgado la Fundación BBVA y la BUAP. <strong>BECA</strong>.
        </p>
        <div class="mt-6 flex items-center text-sm font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 transition-colors">
          <span>Ver Documento</span>
          <svg class="ml-2 w-4 h-4 transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
