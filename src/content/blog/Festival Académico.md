---
title: "XIX Festival Académico de la UEMSTIS - Biología"
description: "Reconocimiento por la participación en la disciplina de Biología durante la etapa estatal del XIX Festival Académico de la UEMSTIS."
pubDate: 2019-03-01
readingTime: "2 min"
tags: ["Biología", "Competencia Académica", "CBTis", "UEMSTIS"]
---

# XIX Festival Académico de la UEMSTIS (Etapa Estatal)

El 1 de marzo de 2019, participé representando al **CBTis No. 16** en la disciplina de **Biología** dentro del marco del **XIX Festival Académico de la UEMSTIS**.

Este evento, organizado por la Unidad de Educación Media Superior Tecnológica, Industrial y de Servicios (UEMSTIS) del estado de Puebla, reúne a estudiantes destacados de diversos planteles para competir en conocimientos académicos. La etapa estatal tuvo lugar en las instalaciones del Centro de Bachillerato Tecnológico Industrial y de Servicios No. 16 "Enrique Flores Magón" en la ciudad de Atlixco, Puebla.

<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/188x0vsSF4sZ9OS8Nj9A1QIZ6uAe7bGTp/view?usp=sharing" 
    target="_blank" 
    ...
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        <div class="flex items-center space-x-2 mb-3">
          ...
          <span class="text-xs font-medium text-zinc-500">Festival - CBTIS 2019</span>
        </div>
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Reconocimiento </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al reconocimiento otorgado por la UEMSTIS y el CBTis No. 16. <strong>CBTIS</strong>.
        </p>
