---
title: "La Cardenista, colonia Lázaro Cárdenas en el municipio de Acajete"
description: "Feria de ciencias en la Cardenista, colonia Lázaro Cárdenas en el municipio de Acajete"
pubDate: 2022-05-24
readingTime: "5 min"
tags: ["Descubriendo Pequeños Científicos", "STEM"]
---

# Feria de ciencias en la Cardenista, colonia Lázaro Cárdenas en el municipio de Acajete

Conoce mi participación en el proyecto de Descubriendo Pequeños Científicos como encargado de evidencias fotográficas y redes sociales.


<div class="my-10 group">
  <a 
    href="https://www.facebook.com/share/p/1J4ihc29No/" 
    target="_blank" 
    ...
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        <div class="flex items-center space-x-2 mb-3">
          <span class="px-2 py-1 text-[10px] font-bold uppercase tracking-wider text-white bg-blue-600 rounded-md">Publicación</span>
          <span class="text-xs font-medium text-zinc-500">Evento - STEM 2022</span>
        </div>
