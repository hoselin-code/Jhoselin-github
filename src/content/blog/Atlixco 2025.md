...
Como parte de la celebración del Segundo Encuentro Nacional de Niñas STEM, evento que se organizó en conjunto con la Asociación Astronómica Metzteocuitlatl, la Dirección General de Universidades Tecnológicas y Politécnicas (CGUTyP) y la Secretaria de Educación  Publica, en el estado de Puebla, con sede en la primaria Gral. Ignacio Zaragoza, en Atlixco, el pasado 24 de Junio. 

## Resultados

Lleve a cabo la coordinación del evento, así como las evidencias audiovisuales y el contenido multimedia.


<div class="my-10 group">
  <a 
    href="https://www.facebook.com/share/p/189jfntyJA/" 
    target="_blank" 
  ...
  >
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        ...
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Publicación </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Mira toda la nota en la publicación de Facebook. <strong>STEM</strong>.
        </p>
  ...
  >
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        ...
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al reconocimiento otorgado por la Dirección de Universidades Tecnológicas y Politéctincas por mi participación en la organización del evento. <strong>STEM</strong>.
        </p>
        <div class="mt-6 flex items-center text-sm font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 transition-colors">
  ...
  >
    <div class="flex flex-col sm:flex-row">
      ...
      <div class="p-8 sm:w-2/3 flex flex-col justify-center">
        ...
        <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-2"> Reconocimiento </h3>
        <p class="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed"> Accede al reconocimiento otorgado por la Escuela Primaria Gral. Ignacio Zaragoza por mi participación en el registro de evidfencia fotográfica del evento. <strong>STEM</strong>.
        </p>
        <div class="mt-6 flex items-center text-sm font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 transition-colors">
          <span>Ver Documento</span>
          <svg class="ml-2 w-4 h-4 transition-transform group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
