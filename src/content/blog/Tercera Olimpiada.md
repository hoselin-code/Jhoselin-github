---
title: "Tercera Olimpiada Estatal de Matemáticas (2013)"
description: "Participación destacada en las etapas Regional y Selectiva de la Tercera Olimpiada Estatal de Matemáticas para Alumnos de Primaria, logrando el pase a la Etapa Estatal."
pubDate: 2013-03-09
readingTime: "2 min"
tags: ["Matemáticas", "Competencia", "BUAP", "Premios"]
---

# Tercera Olimpiada Estatal de Matemáticas

Durante el ciclo 2013, recibí el reconocimiento por parte de la **Benemérita Universidad Autónoma de Puebla (BUAP)** y la **Facultad de Ciencias Físico Matemáticas (FCFM)** por mi desempeño en el circuito de competencias matemáticas a nivel primaria.

Este logro se consolidó a través de dos etapas clasificatorias clave:

1.  **Etapa Regional (26 de enero de 2013):** Participación destacada que otorgó el derecho a avanzar a la fase selectiva.
2.  **Etapa Selectiva (9 de marzo de 2013):** Reconocimiento por obtener los resultados necesarios para clasificar a la **Etapa Estatal** de la olimpiada.

Ambos reconocimientos fueron avalados por el Dr. José Ramón Enrique Arrazola Ramírez, Director de la F.C.F.M., y la Dra. María Araceli Juárez Ramírez, Delegada Estatal de la Olimpiada Nacional de Matemáticas para Alumnos de Primaria y Secundaria (ONMAP/ONMAS).

<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/1kRr0iMtkGcXf5_t71OROPganw6GF96I8/view?usp=sharing" 
    target="_blank" 
...
<div class="my-10 group">
  <a 
    href="https://drive.google.com/file/d/1_Qa_eNNirLZxRsudVcc2KS10momfcPYX/view?usp=sharing" 
    target="_blank" 
    rel="noopener noreferrer"
    class="relative block overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-md transition-all duration-300 ease-out hover:-translate-y-2 hover:shadow-2xl hover:border-zinc-400 dark:hover:border-zinc-600"
  >
